...
-- DivisionCardSerialNumber table
...
-- Railwayuser table (division_id as VARCHAR)
...
-- Application table (division_id as VARCHAR)
...
INSERT INTO StationLocation (station_id, stationname, statename, Divisionname) VALUES
  ...
  (104, 'Guntur Jn',       'Andhra Pradesh', 'Vijayawada'),
...
INSERT INTO Applicant (
    ...
    gender, address, pin_code, city, statename, station_id,
...
-- New 5
 ('Sunita Patil',  '9000000021','patil@123','Rajesh Patil', 'sunita.patil@example.com','1991-06-06','Female','12 MG Road',      '600006','Chennai',          'Tamil Nadu',      105,'Visually Impaired',    'submitting','1'),
 ('Arjun Kumar',   '9000000022','arjun@234','Mohan Kumar',  'arjun.kumar@example.com','1992-07-07','Male',  '34 Park Lane',     '500003','Hyderabad',        'Telangana',       101,'Hearing Impairment',   'submitting','1'),
 ('Latha Reddy',   '9000000023','latha@345','Kiran Reddy',  'latha.reddy@example.com','1993-08-08','Female','56 Nehru Colony',  '520003','Vijayawada',       'Andhra Pradesh',  103,'Locomotor Disability', 'submitting','1'),
 ('Deepak Sharma', '9000000024','deepak@456','Sunita Sharma','deepak.sharma@example.com','1994-09-09','Male',  '78 Lake View',     '522003','Guntur',           'Andhra Pradesh',  104,'Multiple Disabilities','submitting','1'),
 ('Priyanka Singh','9000000025','priya@567','Anil Singh',   'priyanka.singh@example.com','1995-10-10','Female','90 Hill Top',      '500004','Secunderabad',    'Telangana',       102,'Intellectual Disability','submitting','1');

-- Populate Railwayuser Table (15 users from 3 divisions)
INSERT INTO Railwayuser (
    name, mobile_number, email, password, current_level, division_id, statename, station_id, validity_id
) VALUES
-- Secunderabad
 ('Rajesh Rao',   '9000000001','rajesh.rao@railway.com',   'pass@123', '1','Secunderabad','Telangana',      101,'1'),
 ('Meena Iyer',   '9000000002','meena.iyer@railway.com',   'meena#pw', '2','Secunderabad','Telangana',      102,'1'),
 ('Kiran Reddy',  '9000000003','kiran.reddy@railway.com',  'kiran@456','2','Secunderabad','Telangana',      101,'1'),
 ('Farhan Ali',   '9000000004','farhan.ali@railway.com',   'farhan$12','2','Secunderabad','Telangana',      102,'1'),
 ('Sangeeta Das', '9000000005','sangeeta.das@railway.com', 'sangee@789','3','Secunderabad','Telangana',      101,'1'),
-- Vijayawada
 ('Ravi Teja',    '9000000006','ravi.teja@railway.com',    'ravi#234','1','Vijayawada',  'Andhra Pradesh',103,'1'),
 ('Deepika Nair', '9000000007','deepika.nair@railway.com', 'deep@567','2','Vijayawada',  'Andhra Pradesh',103,'1'),
 ('Satish Kumar', '9000000008','satish.kumar@railway.com', 'satish@890','2','Vijayawada',  'Andhra Pradesh',104,'1'),
 ('Anusha R',     '9000000009','anusha.r@railway.com',     'anusha#123','2','Vijayawada',  'Andhra Pradesh',104,'1'),
 ('Harsha M',     '9000000010','harsha.m@railway.com',     'harsha@pass','3','Vijayawada',  'Andhra Pradesh',103,'1'),
-- Chennai
 ('Raghav Menon', '9000000011','raghav.m@railway.com',     'raghav@pw','1','Chennai','Tamil Nadu',     105,'1'),
 ('Lalitha S',    '9000000012','lalitha.s@railway.com',     'lalitha#pw','2','Chennai','Tamil Nadu',     105,'1'),
 ('Naveen Raj',   '9000000013','naveen.raj@railway.com',    'naveen@pass','2','Chennai','Tamil Nadu',     105,'1'),
 ('Shweta Rao',   '9000000014','shweta.rao@railway.com',    'shweta@pw','2','Chennai','Tamil Nadu',     105,'1'),
 ('Ganesh V',     '9000000015','ganesh.v@railway.com',      'ganesh#321','3','Chennai','Tamil Nadu',     105,'1');

-- Populate Application Table (10 applications: 5 original + 5 new)
INSERT INTO Application (
    applicant_id, submission_date, process_date, status,
    station_id, division_id,
...
-- Original 5
 (1, NOW(), NULL, 'pending', 101, 'Secunderabad', NULL, NULL, 'System', 'Dr. Anil Kumar', 'MCI12345',
 ...
 (2, NOW(), NULL, 'pending', 102, 'Secunderabad', NULL, NULL, 'System', 'Dr. Sunita Rao',   'DMC67890',
 ...
 (3, NOW(), NULL, 'pending', 103, 'Vijayawada',   NULL, NULL, 'System', 'Dr. Rajeshwari Devi','APMC11223',
 ...
 (4, NOW(), NULL, 'pending', 104, 'Vijayawada',   NULL, NULL, 'System', 'Dr. Krishna Prasad','KMCI44556',
 ...
 (5, NOW(), NULL, 'pending', 105, 'Chennai',      NULL, NULL, 'System', 'Dr. Lakshmi Narayan','TCMC77889',
...
-- New 5
 (6, NOW(), NULL, 'pending', 105, 'Chennai',      NULL, NULL, 'System', 'Dr. Sunil Patil','TNMC123',
 ...
 (7, NOW(), NULL, 'pending', 101, 'Secunderabad', NULL, NULL, 'System', 'Dr. Mohan Kumar','MCI234',
 ...
 (8, NOW(), NULL, 'pending', 103, 'Vijayawada',   NULL, NULL, 'System', 'Dr. Suresh Reddy','APMC345',
 ...
 (9, NOW(), NULL, 'pending', 104, 'Vijayawada',   NULL, NULL, 'System', 'Dr. Krishna Sharma','KMCI456',
 ...
 (10, NOW(), NULL, 'pending',102, 'Secunderabad', NULL, NULL,'System','Dr. Priya Sharma','DMC567',
...
INSERT INTO ApplicationLog (
    application_id, status, station_id, comments, validation_id,
    current_level, assign_date, level_passed_date, generated_card_id, validity_id
) VALUES
-- Original logs for applications 1–5
 (1, 'pending', 101, 'Application received',                '0','0', NOW(), NOW(),    NULL,'0'),
 (1, 'assign',  101, 'Assigned to Level 1 for verification','1','1', NOW(), NULL,    NULL,'1'),
 (2, 'pending', 102, 'Application received',                '1','0', NOW(), NOW(),    NULL,'1'),
 (3, 'pending', 103, 'Application received',                '1','0', NOW(), NOW(),    NULL,'1'),
 (4, 'pending', 104, 'Application received',                '1','0', NOW(), NOW(),    NULL,'1'),
 (5, 'pending', 105, 'Application received',                '1','0', NOW(), NOW(),    NULL,'1'),
-- New logs for applications 6–10
 (6, 'assign',  105, 'Assigned to Level 1 for verification','1','1', NOW(), NULL,    NULL,'1'),
 (7, 'assign',  101, 'Assigned to Level 2 for verification','1','2', NOW(), NULL,    NULL,'1'),
 (8, 'assign',  103, 'Assigned to Level 3 for verification','1','3', NOW(), NULL,    NULL,'1'),
 (9, 'assign',  104, 'Assigned to Level 1 for verification','1','1', NOW(), NULL,    NULL,'1'),
 (10,'assign',  102, 'Assigned to Level 2 for verification','1','2', NOW(), NULL,    NULL,'1');
